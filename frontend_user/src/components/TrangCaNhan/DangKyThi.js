                        ...
                        <div className="card h-100">
                            <div className="card-body">
                                <div className="row gutters">
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div className="form-group">
                                            <label htmlFor="Street">Căn cước công dân</label>
                                            <input type="text" className="form-control" id="Street" placeholder="Nhập CCCD" />
                                        </div>
                                    </div>
                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div className="form-group">
                                            <label htmlFor="Street">Dân tộc</label>
                                            <input type="text" className="form-control" id="Street" placeholder="Nhập dân tộc" />
                                        </div>
                                    </div>
