...
//                             <h2 className="headline" style="font-size: 20px;font-weight: 300;">Học chắc từ nền tảng<br>Ứng dụng hiệu quả CNTT vào thực tế cuộc sống</h2>
//                         </div>
...
//                 <select id="chuongtrinh" name="chuongtrinh[]" multiple="" className="form-control" style="display: none;">
//                     <option value="1">Đồ hoạ đa truyền thông</option><option value="3">Thiết kế website - SEO</option><option value="4">Lập trình và CSDL</option><option value="5">Lập trình di động</option><option value="12">Data Science &amp; Machine Learning</option><option value="14">Data Analysis</option><option value="16">Master DevOps Engineer</option><option value="7">Mạng máy tính</option><option value="10">Tin học văn phòng </option><option value="11">Tin học Quốc tế</option><option value="6">Kiểm thử phần mềm</option>
//                 </select><div id="chuongtrinh-container" className="btn-group" style="width: 220px;"><button type="button" className="multiselect dropdown-toggle btn btn-default" data-toggle="dropdown" title="Chương trình" style="width: 200px; overflow: hidden; text-overflow: ellipsis; padding: 10px 12px;"><span className="multiselect-selected-text">Chương trình</span> </button><ul className="multiselect-container dropdown-menu"><li className="multiselect-item filter" value="0"><div className="input-group"><input className="form-control multiselect-search" type="text" placeholder="Search"><span className="input-group-btn"><button className="btn btn-default multiselect-clear-filter" type="button"><i className="glyphicon glyphicon-remove-circle"></i></button></span></div></li><li className="odd"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="1"> Đồ hoạ đa truyền thông</label></a></li><li className="even"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="3"> Thiết kế website - SEO</label></a></li><li className="odd"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="4"> Lập trình và CSDL</label></a></li><li className="even"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="5"> Lập trình di động</label></a></li><li className="odd"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="12"> Data Science &amp; Machine Learning</label></a></li><li className="even"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="14"> Data Analysis</label></a></li><li className="odd"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="16"> Master DevOps Engineer</label></a></li><li className="even"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="7"> Mạng máy tính</label></a></li><li className="odd"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="10"> Tin học văn phòng </label></a></li><li className="even"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="11"> Tin học Quốc tế</label></a></li><li className="odd"><a tabindex="0"><label className="checkbox"><input type="checkbox" value="6"> Kiểm thử phần mềm</label></a></li></ul></div>
//                 <select id="capdo" name="capdo[]" multiple="" className="form-control" style="display: none;">
//                     <option value="beginner">Cơ bản</option>
//                     <option value="intermediate">Nâng cao</option>
//                     <option value="advanced">Chuyên sâu</option>
//                 </select><div id="capdo-container" className="btn-group" style="width: 220px;"><button type="button" className="multiselect dropdown-toggle btn btn-default" data-toggle="dropdown" title="Cấp độ" style="width: 200px; overflow: hidden; text-overflow: ellipsis; padding: 10px 12px;"><span className="multiselect-selected-text">Cấp độ</span> </button><ul className="multiselect-container dropdown-menu"><li className="multiselect-item filter" value="0"><div className="input-group"><input className="form-control multiselect-search" type="text" placeholder="Search"><span className="input-group-btn"><button className="btn btn-default multiselect-clear-filter" type="button"><i className="glyphicon glyphicon-remove-circle"></i></button></span></div></li><li><a tabindex="0"><label className="checkbox"><input type="checkbox" value="beginner"> Cơ bản</label></a></li><li><a tabindex="0"><label className="checkbox"><input type="checkbox" value="intermediate"> Nâng cao</label></a></li><li><a tabindex="0"><label className="checkbox"><input type="checkbox" value="advanced"> Chuyên sâu</label></a></li></ul></div>

//                 <select id="thoigianhoc" name="thoigianhoc[]" multiple="" className="form-control" style="display: none;">
//                     <option value="0-0cham9">&lt; 1 tháng</option>
//                     <option value="1-3">1 - 3 tháng</option>
//                     <option value="3cham1-36">&gt; 3 tháng</option>
//                 </select><div id="thoigianhoc-container" className="btn-group" style="width: 220px;"><button type="button" className="multiselect dropdown-toggle btn btn-default" data-toggle="dropdown" title="Thời gian học" style="width: 200px; overflow: hidden; text-overflow: ellipsis; padding: 10px 12px;"><span className="multiselect-selected-text">Thời gian học</span> </button><ul className="multiselect-container dropdown-menu"><li className="multiselect-item filter" value="0"><div className="input-group"><input className="form-control multiselect-search" type="text" placeholder="Search"><span className="input-group-btn"><button className="btn btn-default multiselect-clear-filter" type="button"><i className="glyphicon glyphicon-remove-circle"></i></button></span></div></li><li><a tabindex="0"><label className="checkbox"><input type="checkbox" value="0-0cham9"> &lt; 1 tháng</label></a></li><li><a tabindex="0"><label className="checkbox"><input type="checkbox" value="1-3"> 1 - 3 tháng</label></a></li><li><a tabindex="0"><label className="checkbox"><input type="checkbox" value="3cham1-36"> &gt; 3 tháng</label></a></li></ul></div>
...
//                 </select><div id="muchocphi-container" className="btn-group" style="width: 220px;"><button type="button" className="multiselect dropdown-toggle btn btn-default" data-toggle="dropdown" title="Học phí" style="width: 200px; overflow: hidden; text-overflow: ellipsis; padding: 10px 12px;"><span className="multiselect-selected-text">Học phí</span> </button><ul className="multiselect-container dropdown-menu"><li className="multiselect-item filter" value="0"><div className="input-group"><input className="form-control multiselect-search" type="text" placeholder="Search"><span className="input-group-btn"><button className="btn btn-default multiselect-clear-filter" type="button"><i className="glyphicon glyphicon-remove-circle"></i></button></span></div></li><li><a tabindex="0"><label className="checkbox"><input type="checkbox" value="0-999999"> Dưới 1 triệu</label></a></li><li><a tabindex="0"><label className="checkbox"><input type="checkbox" value="1000000-3000000"> Từ 1 → 3 triệu</label></a></li><li><a tabindex="0"><label className="checkbox"><input type="checkbox" value="3000000-7000000"> Từ 3 → 7 triệu</label></a></li><li><a tabindex="0"><label className="checkbox"><input type="checkbox" value="7000000-100000000"> Trên 7 triệu</label></a></li></ul></div>
...
//                                 <div className="khoa-hoc-stats"><span style="display:none;" className="khoa-hoc-level beginner-intermediate"></span><span className="khoa-hoc-duration">10 tuần</span><span className="khoa-hoc-price"><span className="old">7.800.000đ</span><span className="new">6.000.000đ</span></span></div>
//                         </div>
...
//                         <div className="khoa-hoc-sidebar">
//                             <div className="khoa-hoc-image-container">
//                                 <img className="khoa-hoc-image khoa-hoc-image-bottomleft" src="/data/images/mon-hoc-thumb/lap-trinh-di-dong-da-nen-tang-voi-flutter.png" alt="" loading="lazy"></div>
//                             <div className="khoa-hoc-actions">
//                                 <button className="btn button--primary khoa-hoc-action">Chi tiết khóa học</button></div>
//                         </div>
...
//                                 <button className="btn button--primary khoa-hoc-action">Chi tiết khóa học</button></div>
//                         </div>
//                 </a></li><li className="courses" data-program="12" data-level="beginner" data-duration="0" data-tuition="3000000" data-title="artificial intelligence and applications for business" data-description="khóa học cung cấp bức tranh toàn cảnh về những công nghệ tiên tiến dự báo sẽ tác động, ảnh hưởng và định hình tất cả các hoạt động trên thế giới trong hiện tại và tương..." data-duration-alt="0"><a className="khoa-hoc-item" href="/data-science-machine-learning/artificial-intelligence-and-applications-for-business_294">
//                     <div className="khoa-hoc-body">
//                         <div className="khoa-hoc-image-container">
...
//                         <div className="khoa-hoc-sidebar">
//                             <div className="khoa-hoc-image-container">
//                                 <img className="khoa-hoc-image khoa-hoc-image-topleft" src="/data/images/mon-hoc-thumb/artificial-intelligence-and-applications-for-business.png" alt="" loading="lazy"></div>
//                             <div className="khoa-hoc-actions">
//                                 <button className="btn button--primary khoa-hoc-action">Chi tiết khóa học</button></div>
//                         </div>

//                 </a></li></ul><div style="display: none" className="hoc-phi-mon" data-value="7800000,18000000,5000000,4000000,21000000,4500000,2500000,32700000,3000000,22300000,1500000,2450000,6800000,1300000,3900000,26000000,8000000,7000000,3600000,13500000,1600000,26600000,35000000,10000000,2300000,900000,28200000,7500000,5500000,5200000,2400000,29200000,3500000,6000000,300000,3300000,2900000,1700000,2200000,2700000,1100000,2000000,6400000,16200000,8400000,8500000,5800000,3200000,11000000,2600000,50100000,3800000,1800000"></div>
//             </div>
//         </div>
//     </div>
// );
